...
' Epic: EPIC-288383
' Author: Keisha Bolaji
' Created: December 2025
' Updated: December 10, 2025 - Per Brooke's clarifications
...
Sub Generate_2025_RunningCounts()
    ...
    ' Add second TOTAL ALL REPORTS row
    outputRow = outputRow + 1
    Call WriteAllReportsRow(wsOutput, outputRow)
...
Private Sub WriteTotalsRow(ByRef ws As Worksheet, ByVal rowNum As Long, ByRef countyData As Object)
    ...
    ' Column S: "Total GMP Reviewable" label
    ws.Cells(rowNum, 19).Value = "Total GMP Reviewable"
...
Private Sub WriteAllReportsRow(ByRef ws As Worksheet, ByVal rowNum As Long)
'=========================================================================
' Writre the TOTAL ALL REPORTS row (second totals row)
'=========================================================================
...
ws.Cells(rowNum, 20).Formula = "=SUM(H" & prevRow & ",J" & prevRow & ",L" & prevRow & ",N" & prevRow & ",P" & prevRow & ",R" & prevRow & ")"
ws.Cells(rowNum, 20).Font.Bold = True
End Sub
